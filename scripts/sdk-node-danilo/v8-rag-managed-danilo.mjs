...
const TOP_K = Number(process.env.TOP_K ?? 10); // mesmo valor do v7, pra comparação justa
...
console.log("🤖 Chatbot de Venda de Ingressos - LAB AWS Danilo (V8 RAG Managed)");
console.log("===============================================================");
console.log("");
...
if (LOG) {
  writeFileSync(
    LOG,
    `${"═".repeat(78)}\n` +
    `🤖 SESSÃO RAG V8 GERENCIADO INICIADA  ·  ${new Date().toLocaleString("pt-BR")}\n` +
